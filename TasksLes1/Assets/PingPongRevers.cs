...
public class PingPongRevers : MonoBehaviour
{

    public Vector3 finishPosit;
    public Vector3 startPosit;
    ...
    void Update()
    {
        ...
        {
            finishPosit = startPosit;
        }

        if(gameObject.transform.position == finishPosit && finishPosit == startPosit)
        {
            x = Randomiz(-3.25f, 0.1f);
            y = Randomiz(-4.25f, 0.25f);
            z = Randomiz(0.25f, 3.75f);
